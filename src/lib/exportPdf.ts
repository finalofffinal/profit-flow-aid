...
export function exportSalesPdf(salesOrders: SaleOrder[], year: number) {
  ...
  doc.setFontSize(14);
  doc.text(`SO CHI TIET DOANH THU BAN HANG - Nam ${year}`, pageWidth / 2, 50, { align: 'center' });
